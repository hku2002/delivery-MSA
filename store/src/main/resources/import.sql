/* 가게1 */
INSERT INTO store (name, thumbnail_path, delivery_fee, created_at) VALUES ('Store 1', 'http://localhost:8080/image/store/store1_thumbnail.jpg', 3000, now());
...
/* 가게2 */
INSERT INTO store (name, thumbnail_path, delivery_fee, created_at) VALUES ('Store 2', 'http://localhost:8080/image/store/store2_thumbnail.jpg', 3500, now());
